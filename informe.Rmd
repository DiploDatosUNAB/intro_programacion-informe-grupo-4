...
variacion_servicios_mujeres %>%
  ...
  tab_header(title = "Variación entre 1998 y 2018") %>%
  cols_label(variacion = "Variación en p.p", variable = "Variable por País") %>%
  fmt_number(columns = Variación, decimals = 1, dec_mark = ",")
```
  
  
## A continuacion presentaremos la variacion entre puntas y la variacion en toda la serie para exponer la evolucion a lo largo del tiempo
