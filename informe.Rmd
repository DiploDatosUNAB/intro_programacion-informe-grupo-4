...
##Acontinuacion veremos los datos presentados graficamente 

```{r}
 ggplot (variacion_mujeres_2018_1998, aes(y=variacion)) +
   geom_segment(aes(y=variacion, yend=variacion, x=`1998`, xend=`2018`)) +
   geom_text(aes(y=variacion, x=(`1998`+`2018`)/2, label=dif, vjust=1.5)) + 
   geom_point(data=variacion_mujeres_2018_1998, aes(y=variacion, x=value, color=key), size=4) +
   labs(title="Variación del procentaje de la fuerza laboral femenina inserta en la industria", subtitle="Entre los años 1998 y 2018", x="Paises", y="Variación", color="Año") +
     theme_minimal()
```
...
##¿¿¿¿Grafico con la variacion que fueron tomando las variables empleo industria mujeres y hmbres en todos los años de 1998 a 2018 para argentina??
