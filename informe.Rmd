...
\*Para responder a la pregunta, calculamos el promedio para cada uno de los años, de del porcentaje dentro de la fuerza laboral masculina que se encuentra empleado en la industria. Lo mismo hicimos para el caso de las mujeres.
...
ggplot2(data=promedio_industria_x_anio, mapping = aes( x=Anio, y=promedio_industria_hombres))
```
