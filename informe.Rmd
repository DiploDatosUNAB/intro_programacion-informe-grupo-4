...
También incluye el dato de la existencia o no en algunos países de legislación contra el acoso sexual en el ámbito laboral. 
Los datos existentes en la tabla original corresponden a algunos países de Latinoamérica, el Caribe, España y a nivel mundial, para los años que van desde 1970 hasta 2018 (aunque no hay datos de todos los países ni de todos los años).
A partir de estos datos nos haremos preguntas que permitan visualizar las brechas de genero que existen en el empleo y formular posibles hipótesis al respecto, entendiendo que al ser una base de datos construida en términos binarios (varones/mujeres) obtendremos respuestas acotadas a dicha población y no generalizables al conjunto, al no encontrarse representadas otras identidades de género existentes.
...
Seleccionamos los datos de los países latinoamericanos y del Caribe y excluimos los datos etiquetados como "España", "Latin America & Caribbean" y "Mundo" y los agrupamos por año (Anio). 
Para eso, utilizamos la función "filter" y "group_by:
