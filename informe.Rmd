...
```{r}
empleo_genero_largo |> 
  filter(pais_region !="Latin America & Caribbean" & pais_region != "Mundo" & pais_region != "Espa̱a" & Anio == 2018) |> 
  filter(startsWith(variable, "empleador")) |>   
  separate(variable, into = c("tipo", "sexo"), sep = "_") |>  
  group_by(sexo) 
```
