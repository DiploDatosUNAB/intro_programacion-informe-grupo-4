...
##prueba ro para sacar tasa de variacion

```{r}
variacion_2018_1998 <- select(empleo_genero, variable, pais_region, "1998", "2018")|>
  filter(variable == "empleo_industria_hombres" | variable == "empleo_industria_mujeres")|>
  mutate(tasa_variacion=`2018`-`1998`)
```
